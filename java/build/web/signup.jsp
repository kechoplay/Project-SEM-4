...
//                var user_dangki = document.forms["register"]["user_dangki"].value;
//                var pass_dangki = document.forms["register"]["pass_dangki"].value;
//                var fullname_dangki = document.forms["register"]["fullname_dangki"].value;
//                var email_dangki = document.forms["register"]["email_dangki"].value;
//                var mobile_dangki = document.forms["register"]["mobile_dangki"].value;
//                var address_dangki = document.forms["register"]["address_dangki"].value;
//                console.log({user_dangki,pass_dangki,fullname_dangki,email_dangki,mobile_dangki,address_dangki});
//                $.post('UserServlet',{user_dangki,pass_dangki,fullname_dangki,email_dangki,mobile_dangki,address_dangki}, function (data) {
//                        alert(data);
//                    });
//                return false;
            ...
            <div id="signupbox" style=" margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body" >
                        <form id="signupform" class="form-horizontal" role="form" action="/java/UserServlet" onsubmit="return checkValidate()" method="POST" name="register">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="address_dangki" id="address_dangki" placeholder="Địa chỉ" required="" >
                                </div>
                            </div>
                            <div class="form-group">
                                <!-- Button -->     
