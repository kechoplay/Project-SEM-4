<%-- 
    Document   : content
    Created on : Jan 17, 2017, 8:07:45 PM
    Author     : TungVoDoi
--%>
                            ...
                            <div class="row">
                                    ...
                                    <div class="flip margin-bottom-30">
                                        <div class="card">
                                            ...
                                            <div class="face back">
                                                ...
                                                <a href="inventory-listing.html"><i class="fa fa-link button_icon"></i></a> 
                                                <a href="images/car1-lrg.jpg" class="fancybox"><i class="fa fa-arrows-alt button_icon"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 margin-bottom-none">
                                    <div class="flip horizontal margin-bottom-30">
                                        <div class="card">
                                            <div class="face front">
                                                <img class="img-responsive" src="http://demo.themesuite.com/automotive/images/car2.jpg" alt="">
                                            </div>
                                            <div class="face back">
                                                <div class='hover_title'>Family Oriented</div>
                                                <a href="inventory-listing.html"><i class="fa fa-link button_icon"></i></a> 
                                                <a href="images/car2-lrg.jpg" class="fancybox"><i class="fa fa-arrows-alt button_icon"></i></a> 
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 margin-bottom-none">
                                    <div class="flip margin-bottom-30">
                                        <div class="card">
                                            <div class="face front">
                                                <img class="img-responsive" src="http://demo.themesuite.com/automotive/images/car3.jpg" alt="">
                                            </div>
                                            <div class="face back">
                                                <div class='hover_title'>World Class</div>
                                                <a href="inventory-listing.html"><i class="fa fa-link button_icon"></i></a>
                                                <a href="images/car3-lrg.jpg" class="fancybox"><i class="fa fa-arrows-alt button_icon"></i></a>
                                            </div>
                                        </div>
                                    </div>
